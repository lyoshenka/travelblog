...
//<script src="//console.re/connector.js" data-channel="fcb0-1401-0bbb" id="consolerescript"></ script>

//window.onerror = function(message, url, lineNumber) {  

//  //save error and send to server for example.

//console.re.log([message, url, lineNumber]);

//return true;

//};  

//console.re.size(); console.re.media();
...
//        if ($("autopagerize_icon") || navigator.userAgent.indexOf('iPhone') != -1) return;
        ...
        gPFncs[1] = function(aE) {
            ...
            for (var i = 0, l = aE.length; i < l; i++) {
                ...
                var arr = aE[i].className && aE[i].className.split ? aE[i].className.split(" ") : null;
