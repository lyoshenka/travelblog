<?php echo css('assets/styles/photoswipe.css') ?>
<?php echo css('assets/styles/photoswipe-default-skin.css') ?>
...
addClass(document.body, 'photoswipe-enabled');
initPhotoSwipeFromDOM('.photoset');

// also on instantclick change (the below SHOULD fire on first load, but it doesnt, so we replicate above)
